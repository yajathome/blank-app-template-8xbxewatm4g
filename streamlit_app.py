...
def home():
        st.html("<h1 style='font-size:50px;background-color:wheat;padding:20px;border-radius:20px;text-align: center;  margin: auto;width: 60%;MARGIN-TOP: 100PX;'> Agri-Link Soft-ware</h1>")
def ad():
        farm_data = {
